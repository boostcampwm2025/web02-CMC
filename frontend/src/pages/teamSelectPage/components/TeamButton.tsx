...
export default function TeamButton({ team, language, code, description }: TeamButtonProps) {
  ...
  return (
    <div className="relative">
      <button className={`border-[0.1px] rounded-lg bg-[#1E1E2F] min-h-[437px] w-[18rem] ${styles.button}`}>
        ...
        {team === 'NONE' ? (
          ...
          <div
            className={`relative border-[1px] rounded-md w-[85%] mx-auto text-left px-4 py-2 ${styles.codeBlock}`}
